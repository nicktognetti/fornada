  ...
  function adicionarItem() {
    ...
    if (idx >= 0) {
      setItens((prev) => prev.map((i, n) =>
        n === idx ? { ...i, quantidade_enviada: i.quantidade_enviada + qtd } : i
      ))
    } else {
      setItens((prev) => [...prev, {
  ...
  return (
    <div className="max-w-2xl space-y-5">
      ...
      <div className={`${CARD} overflow-hidden`}>
        ...
        {itens.length === 0 ? (
          ...
          <div className="divide-y divide-subtle">
            <div className="hidden sm:grid grid-cols-[1fr_auto_auto] gap-4 px-6 py-2 border-b border-subtle bg-canvas">
            ...
            {itens.map((item) => (
              <div
                key={item.produto_id}
                className="grid items-center gap-3 px-6 py-3.5 hover:bg-input transition-colors grid-cols-[1fr_auto] sm:grid-cols-[1fr_auto_auto]"
              >
      ...
      {modalOpen && (
        ...
        >
          <div className="w-full max-w-[520px] flex flex-col max-h-[78vh] bg-surface border border-subtle rounded-xl shadow-2xl shadow-black/40">
            {/* Header */}
                ...
                <div className="flex flex-col items-center py-12 gap-3 text-center">
                  ...
                  <div>
                    ...
                    <p className="text-secondary text-sm mt-1 max-w-xs mx-auto">
                      Cadastre produtos antes de criar uma transferência.
                    </p>
                  </div>
                </div>
            ...
            <div className="shrink-0 px-6 py-4 border-t border-subtle space-y-3">
              ...
              <div className="flex items-end gap-3">
                <div>
                  <label className={LABEL}>Quantidade <span className="normal-case font-normal tracking-normal text-faint">(un)</span></label>
                  <input
                    type="text"
                    inputMode="decimal"
                    value={qtdInput}
