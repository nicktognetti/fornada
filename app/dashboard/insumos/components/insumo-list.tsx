        ...
        <div className="space-y-2">
          {filtered.map((insumo) => (
            <div
              ...
              className="card-surface flex items-center gap-4 px-5 py-4 group hover:shadow-md hover:bg-input transition-all cursor-pointer"
            >
              <div className="flex-1 min-w-0 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                    ...
                    <span className="text-secondary text-[12px]">{insumo.unidade_uso}</span>
                    {insumo.fichasCount > 0 && (
                      <span className="text-secondary/50 text-[12px]">
              ...
              <button
                ...
                className="shrink-0 w-9 h-9 rounded-xl flex items-center justify-center text-secondary/40 hover:text-accent-primary hover:bg-accent-primary/10 border border-transparent hover:border-accent-primary/20 transition-all opacity-0 group-hover:opacity-100"
